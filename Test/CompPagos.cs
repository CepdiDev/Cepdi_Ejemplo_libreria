using Cepdi.ComplementoPagos.Models.Version20;
using System;
using System.Collections.Generic;
using TimbradoCepdi.Comprobante40;
...
namespace Test
{
    class CompPagos
    {
        public void TestPagos()
        {
            ...
            /*************************************************************************************************************************************************/
            /*************************************************************************************************************************************************/
            var complementoPago = new Cepdi.ComplementoPagos.Models.Version20.Pagos()
            {
                Version="2.0",//objeto ComplementoConcepto el cual se captira la totalidad Descuento los impuestos totales de un producto o servicio.
            };
            var listaDePagos = new List<Cepdi.ComplementoPagos.Models.Version20.PagosPago>();
            var pago = new Cepdi.ComplementoPagos.Models.Version20.PagosPago()
            {
                FechaPago = "2023-11-29T12:00:00",//Atributo requerido para expresar la fecha y hora en la que el beneficiario recibe el pago. Se expresa en la forma aaaa-mm-ddThh:mm:ss, de acuerdo con la especificación ISO 8601.En caso de no contar con la hora se debe registrar 12:00:00.
                FormaDePagoP = "03",//Atributo requerido para expresar la clave de la forma en que se realiza el pago.
                ...
                TipoCambioP = 1m,//Atributo condicional para expresar el tipo de cambio de la moneda a la fecha en que se realizó el pago. El valor debe reflejar el número de pesos mexicanos que equivalen a una unidad de la divisa señalada en el atributo MonedaP. Es requerido cuando el atributo MonedaP es diferente a MXN.
                TipoCambioPSpecified=true,//Indicador booleano que especifica si se incluye el atributo TipoCambioP en el XML.
                Monto = 100m,//Atributo requerido para expresar el importe del pago.
                NumOperacion = "1",//Atributo condicional para expresar el número de cheque, número de autorización, número de referencia, clave de rastreo en caso de ser SPEI, línea de captura o algún número de referencia análogo que identifique la operación que ampara el pago efectuado
            ...
            var listaDoctoRelacionado  = new List<Cepdi.ComplementoPagos.Models.Version20.PagosPagoDoctoRelacionado>();
            var docto = new Cepdi.ComplementoPagos.Models.Version20.PagosPagoDoctoRelacionado()
            {
                IdDocumento = "a0476c1b-8829-448d-82ab-92d8b26be878",//Atributo requerido para expresar el identificador del documento relacionado con el pago. Este dato puede ser un Folio Fiscal de la Factura Electrónica o bien el número de operación de un documento digital.
                ...
                EquivalenciaDR = 1m,//Atributo condicional para expresar el tipo de cambio conforme con la moneda registrada en el documento relacionado. Es requerido cuando la moneda del documento relacionado es distinta de la moneda de pago. Se debe registrar el número de unidades de la moneda señalada en el documento relacionado que equivalen a una unidad de la moneda del pago. Por ejemplo: El documento relacionado se registra en USD El pago se realiza por 100 EUR. Este atributo se registra como 1.114700 USD/EUR. El importe pagado equivale a 100 EUR * 1.114700 USD/EUR = 111.47 USD.                
                EquivalenciaDRSpecified = true,//Indicador booleano que especifica si se incluye el atributo EquivalenciaDR en el XML.
                NumParcialidad = "1",//Atributo condicional para expresar el número de parcialidad que corresponde al pago. Es requerido cuando MetodoDePagoDR contiene: “PPD” Pago en parcialidades o diferido.
                ImpSaldoAnt = 98.75m,//Atributo condicional para expresar el monto del saldo insoluto de la parcialidad anterior. Es requerido cuando MetodoDePagoDR contiene: “PPD” Pago en parcialidades o diferido.En el caso de que sea la primer parcialidad este campo debe contener el importe total del documento relacionado.
                ImpPagado = 98.75m,//Atributo condicional para expresar el importe pagado para el documento relacionado. Es obligatorio cuando exista más de un documento relacionado o cuando existe un documento relacionado y el TipoCambioDR tiene un valor.
                ImpSaldoInsoluto = 0.00m,//Atributo condicional para expresar la diferencia entre el importe del saldo anterior y el monto del pago. Es requerido cuando MetodoDePagoDR contiene: “PPD” Pago en parcialidades o diferido.
                ObjetoImpDR = "02",//Atributo condicional para identificar el objeto del impuesto del documento relacionado (conforme al catálogo correspondiente).
                ImpuestosDR = new PagosPagoDoctoRelacionadoImpuestosDR()
                {
                    RetencionesDR = new PagosPagoDoctoRelacionadoImpuestosDRRetencionDR[1] {
                        new PagosPagoDoctoRelacionadoImpuestosDRRetencionDR()
                        { 
                            BaseDR=100.00m,//Atributo condicional que indica la base del impuesto retenido.
                            ImpuestoDR="002",//Atributo requerido para señalar la clave del tipo de impuesto retenido.
                            TipoFactorDR="Tasa",//Atributo requerido para señalar la clave del tipo de factor aplicado a la base.
                            TasaOCuotaDR=0.160000m,//Atributo requerido para expresar la tasa o cuota aplicada a la base.
                            ImporteDR=16.00m//Atributo requerido para expresar el importe del impuesto retenido.
                        } }
                    ,TrasladosDR = new PagosPagoDoctoRelacionadoImpuestosDRTrasladoDR[1]
                    {
                        new PagosPagoDoctoRelacionadoImpuestosDRTrasladoDR()
                        {
                            BaseDR=100.00m,//Atributo condicional que indica la base del impuesto trasladado.
                            ImpuestoDR="002",//Atributo requerido para señalar la clave del tipo de impuesto trasladado.
                            TipoFactorDR="Tasa",//Atributo requerido para señalar la clave del tipo de factor aplicado a la base.
                            TasaOCuotaDR=0.160000m,//Atributo requerido para expresar la tasa o cuota aplicada a la base.
                            TasaOCuotaDRSpecified=true,//Indicador booleano que especifica si se incluye la tasa o cuota del traslado.
                            ImporteDR=16.00m,//Atributo requerido para expresar el importe del impuesto trasladado.
                            ImporteDRSpecified = true//Indicador booleano que especifica si se incluye el importe del traslado.
                        }
                    }
                }
            };
            ...
            var listaImpuestoRetencionespago = new List<Cepdi.ComplementoPagos.Models.Version20.PagosPagoImpuestosPRetencionP>();
            var Retenciones = new Cepdi.ComplementoPagos.Models.Version20.PagosPagoImpuestosPRetencionP()
            {
                ImporteP = 16.00m,//Atributo requerido para señalar el importe o monto del impuesto retenido. No se permiten valores negativos.               
                ImpuestoP = "002",//Atributo requerido para señalar la clave del tipo de impuesto retenido.
            };
            listaImpuestoRetencionespago.Add(Retenciones);
            var listaImpuestoTrasladadosPago = new List<PagosPagoImpuestosPTrasladoP>();
            var Traslados = new Cepdi.ComplementoPagos.Models.Version20.PagosPagoImpuestosPTrasladoP()
            {
                BaseP = 100.00m,//Atributo condicional que indica la base del impuesto trasladado.
                ImpuestoP = "002",//Atributo requerido para señalar la clave del tipo de impuesto trasladado.
                TipoFactorP = "Tasa",//Atributo requerido para señalar la clave del tipo de factor que se aplica a la base del impuesto.
                TasaOCuotaP = 0.160000m,//Atributo requerido para señalar el valor de la tasa o cuota del impuesto que se traslada.
                TasaOCuotaPSpecified = true,//Indicador booleano que especifica si se incluye la tasa o cuota del traslado.
                ImporteP = 16.00m,//Atributo requerido para señalar el importe del impuesto trasladado. No se permiten valores negativos.
                ImportePSpecified = true//Indicador booleano que especifica si se incluye el importe del traslado.
            };
            listaImpuestoTrasladadosPago.Add(Traslados);
            var impuestoDePago = new Cepdi.ComplementoPagos.Models.Version20.PagosPagoImpuestosP()
            {

                RetencionesP = listaImpuestoRetencionespago.ToArray(),//Atributo condicional para expresar el total de los impuestos retenidos que se desprenden del pago. No se permiten valores negativos.
                TrasladosP = listaImpuestoTrasladadosPago.ToArray(),//Atributo condicional para expresar el total de los impuestos trasladados que se desprenden del pago. No se permiten valores negativos.
            };                        


            pago.ImpuestosP = impuestoDePago;//Atributo condicional para expresar los impuestos que se desprenden del pago.            


            pago.DoctoRelacionado = listaDoctoRelacionado.ToArray();//Atributo condicional para relacionar los documentos a los que corresponde el pago.
            listaDePagos.Add(pago);
            complementoPago.Pago = listaDePagos.ToArray();//Atributo requerido para contener la lista de pagos del complemento.
            complementoPago.Totales = new PagosTotales()
            {
                TotalRetencionesIVA = 16,//Atributo condicional para expresar el total de retenciones de IVA del complemento Pagos.
                TotalRetencionesIVASpecified = true,//Indicador booleano que especifica si se incluye TotalRetencionesIVA.
                TotalTrasladosBaseIVA16 = 100,//Atributo condicional que indica la base total trasladada a IVA 16%.
                TotalTrasladosBaseIVA16Specified = true,//Indicador booleano que especifica si se incluye TotalTrasladosBaseIVA16.
                TotalTrasladosImpuestoIVA16 = 16,//Atributo condicional para expresar el total del impuesto trasladado correspondiente a IVA 16%.
                TotalTrasladosImpuestoIVA16Specified = true,//Indicador booleano que especifica si se incluye TotalTrasladosImpuestoIVA16.
                MontoTotalPagos = 100//Atributo requerido para expresar la suma total de los pagos incluidos en el complemento.
            };
            /*************************************************************************************************************************************************/
            /*************************************************************************************************************************************************/
            ...
            comprobante.Emisor = new ComprobanteEmisor()
            {
                ...
                Nombre = "XENON INDUSTRIAL ARTICLES",//Atributo requerido para el nombre o razón social del emisor.
                Rfc = "XIA190128J61",//Atributo requerido para el RFC del emisor.
                RegimenFiscal = "601"//Atributo requerido para indicar el régimen fiscal del emisor.
            ...
            comprobante.Receptor = new ComprobanteReceptor()
            {
                ...
                Nombre = "UNIVERSIDAD ROBOTICA ESPAÑOLA",//Atributo requerido para el nombre o razón social del receptor.
                // NumRegIdTrib = "MSS091104LRA",
                Rfc = "URE180429TM6",//Atributo requerido para el RFC del receptor.
                UsoCFDI = "CP01",//Atributo requerido para indicar el uso que el receptor dará al CFDI.
                DomicilioFiscalReceptor = "86991",//Atributo opcional para el código postal del domicilio fiscal del receptor.
                RegimenFiscalReceptor = "601"//Atributo requerido para indicar el régimen fiscal del receptor.
            ...
            comprobante.LugarExpedicion = "11590";//Atributo requerido para incorporar el código postal del lugar de expedición del comprobante (domicilio de la matriz o de la sucursal).             
            ...
            var concepto = new ComprobanteConcepto()
            {
                ...
                Descuento = 0m,//Atributo opcional para expresar el monto de descuento aplicado al concepto.
                ObjetoImp = "01"//Atributo requerido para indicar el objeto del impuesto del concepto (conforme al catálogo correspondiente).
            ...
            TimbradoCepdi.V33.ComplementoSat pagos = new TimbradoCepdi.V33.ComplementoSat();
            pagos.Prefix = "pago20";//Prefijo usado para el nodo del complemento en el XML.
            pagos.NameSpace = "http://www.sat.gob.mx/Pagos20";//Espacio de nombres del complemento Pagos versión 2.0.
            pagos.Complemento = complementoPago;//Objeto que contiene los datos del complemento Pagos.
            comprobante.ListaComplementos = new List<TimbradoCepdi.V33.ComplementoSat>();
            comprobante.ListaComplementos.Add(pagos);
            //*************Llenado de datos extra**********************//
            var datos_Extra = new TimbradoCepdi.WS.datosExtra();

            datos_Extra.Email = "";//Correo electrónico asociado a los datos adicionales.
